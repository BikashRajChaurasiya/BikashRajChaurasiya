# 👋 Hello, I'm Bikash Raj Chaurasiya
...
🔹 AWS Certified: professional with hands-on experience in SageMaker, Comprehend, and Data Pipelines  
...
DAV College, Lalitpur |021 - 2023 | CGPA: 3.15/4.0
...
💼 E-Commerce Developer
-Built a fully responsive e-commerce platform using HTML, CSS, and JavaScript
-Developed an advanced product inventory system with search & filtering
-Improved overall UI/UX to boost user engagement and navigation

📉Data Visualization & BI Analyst | Power BI Project

-Led an end-to-end Power BI dashboard development project to analyze multi-location coffee shop sales performance. Integrated 8+ data sources, built a star schema data model, and created advanced DAX measures for KPIs including revenue, AOV, YoY growth, and target variance. Designed interactive dashboards for executive overview, sales trends, store mapping, and product insights—enabling data-driven decisions that identified top-performing stores, peak sales periods, and promotional impacts.
...
“The path to becoming a great programmer is paved with the programs you write.”-Bikashraj_84Ya
